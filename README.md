...
**https://hack.technokod.kz** — демонстрационная страница результата: почасовой прогноз февраля 2026 по обеим турбинам с интервалом P10–P90, метрики честной валидации, сравнение с эталонами и разбор реального выпуска агента с трассой вызванных инструментов. Статика на Cloudflare Workers, от рабочей машины не зависит, ключи не требуются. Исходник страницы — `docs/index.html`, данные графика — `docs/demo/forecast-feb2026.js`, выкат командой `npx wrangler deploy` по конфигурации `wrangler.jsonc`.
